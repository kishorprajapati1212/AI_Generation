...
const ResponsiveGallery = () => {
    ...
    return (
      <>
      {/* <span  style={{ position:'relative', left:'40%', transform: 'translateX(-40%)' ,color:'blue', borderBottom: '2px solid blue' ,fontWeight:"700",
            fontSize:"4rem", fontFamily:'roboto'}}>EXIBITION</span> */}
        <Box
          sx={{
            display: 'flex',
